...
interface QrCodeApi {
     ...
     */
    fun createBase64QrCodeImage(qrCodeConfig: QrCodeConfig): String =
        createQrCodeImage(qrCodeConfig).toBase64()
     ...
     * @return base64 encoded String
     */
    fun createBase64QrCodeImage(qrCodeConfig: QrCodeConfig, imageFormatName: String = "png"): String =
        createQrCodeImage(qrCodeConfig).toBase64(imageFormatName)
}
