...
image:https://github.com/SimonScholz/qr-code-with-logo/actions/workflows/CI.yaml/badge.svg[CI/CD,link=https://github.com/SimonScholz/qr-code-with-logo/actions/workflows/CI.yaml]
image:https://img.shields.io/maven-central/v/io.github.simonscholz/qr-code-with-logo?label=maven+central[Maven Central,link=https://central.sonatype.com/search?namespace=io.github.simonscholz]
image:https://img.shields.io/badge/license-Apache%20License%202.0-blue.svg?style=flat[Apache License 2.0,link=https://www.apache.org/licenses/LICENSE-2.0]
...
Examples for Java or Kotlin can be found in the https://github.com/SimonScholz/qr-code-with-logo/blob/main/java-sample/src/main/java/io/github/simonscholz[`java-sample`] or https://github.com/SimonScholz/qr-code-with-logo/blob/main/kotlin-sample/src/main/kotlin/io/github/simonscholz[`kotlin-sample`] module.
...
----
dependencies {
    implementation("io.github.simonscholz:qr-code-with-logo:0.6.0")
    // Optional if you´d want to create QR code SVG images
    implementation("io.github.simonscholz:qr-code-with-logo-svg:0.6.0")
}
----
...
dependencies {
    implementation("io.github.simonscholz:qr-code-with-logo:0.7.0-SNAPSHOT")
    // Optional if you´d want to create QR code SVG images
    implementation("io.github.simonscholz:qr-code-with-logo-svg:0.7.0-SNAPSHOT")
}
----
...
For more advanced examples, please have a look at the https://github.com/SimonScholz/qr-code-with-logo/blob/main/kotlin-sample/src/main/kotlin/io/github/simonscholz[`kotlin-sample` module].
...
final var qrCode = qrCodeApi.createQrCodeImage(new QrCodeConfig("https://simonscholz.dev/", DEFAULT_IMG_SIZE));
ImageIO.write(qrCode, "png", new File("qr-with-defaults-java.png"));
----

For more advanced examples, please have a look at the https://github.com/SimonScholz/qr-code-with-logo/blob/main/java-sample/src/main/java/io/github/simonscholz[`java-sample` module].
...
In order to create certain types of QR codes, you may want to use the following utils.
...
String vEventQrCodeText = new VEvent()
...
```java
String vCardQrCodeText = new VCard()
...
EPC GiroCode (SEPA Credit Transfer) type:

```java
String epcGiroCodeQrCodeText = new EpcGiroCode()
                .bic("DEUTDEFFXXX")
...
The `epcGiroCodeQrCodeText` can then be used to create a QR code.
