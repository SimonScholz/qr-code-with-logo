...
internal object BorderGraphics {
    fun drawBorder(graphics: Graphics2D, borderColor: Color, size: Int, relativeBorderRound: Double, relativeBorderSize: Double): Unit {
        ...
        graphics.fillRoundRect(
            relativeSize / 2, relativeSize / 2, size - relativeSize, size - relativeSize,
