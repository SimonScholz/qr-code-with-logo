...
data class QrCodeConfig @JvmOverloads constructor(val qrCodeText: String, val qrCodeSize: Int, val qrCode: QrCode = QrCode(), val positionalSquares: PositionalSquares = PositionalSquares(), val border: Border = Border(), val logo: Logo? = null)
